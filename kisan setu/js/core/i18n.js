...
(function(window) {
    ...
    const DICTIONARY = {
        ...
        hi: {
            ...
            reason: "कारण / समस्या का विवरण",
            reason_ph: "ऑर्डर या भुगतान से संबंधित समस्या का विवरण दें...",
            submit_dispute: "विवाद सबमिट करें",
            submitting: "सबमिट हो रहा है...",

            // Logistics
            logistics_title: "परिवहन एवं लॉजिस्टिक्स",
            logistics_sub: "फसल उठाव (पिकअप), वाहन बेड़ा और डिलीवरी स्थिति ट्रैक करें।",
            request_logistics: "प्रखंड लॉजिस्टिक्स का अनुरोध करें",
            pickup_location: "पिकअप स्थान (खेत / गाँव)",
            pickup_location_ph: "उदा. ग्राम रामपुर, प्रखंड बाढ़",
            drop_destination: "खरीदार का गंतव्य / मंडी",
            ...
            th_status: "स्थिति (Status)",
            th_action: "कार्रवाई",
            th_date: "दिनांक",
            th_prakhand: "प्रखंड / ब्लॉक",
            th_name: "नाम",
            th_phone: "मोबाइल",
            th_email: "ईमेल",
            th_district: "जिला",
            ...
            STATUS_DISPUTED: "विवादित (Disputed)",
    ...
    function translateUntaggedUI(lang) {
        if (lang === "hi") {
            const selector = "h1, h2, h3, h4, th, label, .nav-item > span, .card-title, .stat-info > span, .quick-action strong, .quick-action span, .section-title, button:not(.lang-toggle-btn):not(.language-button), .stat-card small, .role-button > span";
