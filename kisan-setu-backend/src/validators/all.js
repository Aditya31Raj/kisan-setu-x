...
export const disputeSchema=z.object({orderId:z.string().uuid(),reason:z.string().min(5).max(5000),evidence:z.record(z.string(),z.any()).optional()}); export const disputeResolveSchema=z.object({resolution:z.string().min(3),status:z.enum(['RESOLVED','REJECTED'])});
